...
SOCKET startServer(char** argv, int noOfListeners, struct sockaddr_in address, int addrlen) {
    int result;
    ...
    result = listen(serverSocket, noOfListeners);
    if(result == SOCKET_ERROR) {
...
int main(int argc, char** argv) {
    ...
    printf("No of listeners?");
    scanf_s("&d", x);
    SOCKET serverSocket = startServer(argv, x, address, addrlen);
